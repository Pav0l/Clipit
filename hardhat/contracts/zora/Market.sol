...
import { ZoraMedia } from "./Media.sol";
 ...
 */
contract ZoraMarket is IMarket {
  ...
  function _finalizeNFTTransfer(uint256 tokenId, address bidder) private {
    ...
    token.safeTransfer(ZoraMedia(mediaContract).tokenCreators(tokenId), splitShare(bidShares.creator, bid.amount));
